...
<%@ include file="admin_menu.jsp" %>
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="index.html">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="admin_user.jsp">用户管理</a><span class="crumb-step">&gt;</span><span>新增用户</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="/MongkeyShop/manage/admin_douseradd" method="post" id="myform" name="myform">
                        ...
                        <tbody>
                            ...
                            <tr>
                             ...
                             <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title4" name="rePassWord" size="50" value="" type="text">
                                </td>
                            </tr>
                            ...
                            <tr>
                              ...
                              <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title5" name="email" size="50" value="" type="text">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title6" name="mobile" size="50" value="" type="text">
                                </td>
                            </tr>
